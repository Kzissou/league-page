/*   STEP 1   */
export const leagueID = "923840130266329088"; // your league ID
export const leagueName = "Ricky Williams Elite DYNASTY League of Super Buds"; // your league name
...
export const managers = [
     {
       "Double D.J.'s": 1,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "David": "Your Name",
      "bio": "God, fantasy, family",
